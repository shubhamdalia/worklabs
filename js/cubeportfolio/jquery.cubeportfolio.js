        ...
        resizeEvent: function() {
            ...
            CubePortfolio.private.initResizeEvent({
                ...
                fn: function() {
                    ...
                    tt.triggerEvent('resizeWintrodow');
                }
            });
        },
        ...
        t.parent.$obj.on('initComplete.cbp', function() {
            Object.create({
                ...
                getNewItems: function() {
                    ...
                    topWintrodow = self.window.scrollTop() + self.window.height();

                    if (topLoadMore > topWintrodow) {
                        return;
                    }
...
(function($, window, document, undefined) {
    ...
    var popup = {
        ...
        init: function(cubeportfolio, type) {
            ...
            if (type === 'lightbox') {
                t.cubeportfolio.registerEvent('resizeWintrodow', function() {
                    t.resizeImage();
                });
            }

...
$.fn.simpleLightbox = function( options )
{
	...
	var touchDevice	= ( 'ontouchstart' in window ),
		...
		handleScrollbar = function(type){
			...
			if(type == 'hide'){
				var fullWintrodowWidth = window.innerWidth;
				if (!fullWintrodowWidth) {
					var documentElementRect = document.documentElement.getBoundingClientRect();
					fullWintrodowWidth = documentElementRect.right - Math.abs(documentElementRect.left);
				}
				if(document.body.clientWidth < fullWintrodowWidth){

...
var putVinPosition = function(el,o,opt) {
	...
	var elh = el.outerHeight(true),
		...
		by = o.container=="layergrid" ? opt.sliderLayout=="fullscreen" ? opt.height/2 - (opt.gridheight[opt.curWintroRange]*opt.bh)/2 : (opt.autoHeight=="on" || (opt.minHeight!=undefined && opt.minHeight>0)) ? oh/2 - (opt.gridheight[opt.curWintroRange]*opt.bh)/2  : 0 : 0,		
...
var putHinPosition = function(el,o,opt) {
	...
	var elh = el.outerHeight(true),
		elw = el.outerWidth(true),
		bx = o.container=="layergrid" ? opt.sliderType==="carousel" ? 0 : opt.width/2 - (opt.gridwidth[opt.curWintroRange]*opt.bw)/2 : 0,
